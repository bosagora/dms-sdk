...
import { IClientWeb3MainCore } from "../interfaces/core";
...
import {
    ...
    NoOuterChainBridgeAddress
} from "../../utils/errors";

import { UnsupportedNetworkError } from "kios-sdk-common-v2";

const networkMap = new Map<Web3MainChainModule, Networkish>();
const providersMap = new Map<Web3MainChainModule, JsonRpcProvider>();
const signerMap = new Map<Web3MainChainModule, Signer>();

const tokenAddressMap = new Map<Web3MainChainModule, string>();
const loyaltyBridgeAddressMap = new Map<Web3MainChainModule, string>();
const innerChainBridgeAddressMap = new Map<Web3MainChainModule, string>();
const outerChainBridgeAddressMap = new Map<Web3MainChainModule, string>();

export class Web3MainChainModule implements IClientWeb3MainCore {
    constructor(context: MainContext) {
        ...
        Object.freeze(Web3MainChainModule.prototype);
        Object.freeze(this);
    }
